                            ...
                            <div class="login-wrapper">
                                <div class="box">
                                    <div class="content-wrap">
                                        ...
                                        <c:if test="${showAccountError == false}">
                                            <jsp:useBean id="account" scope="request" type="com.system.entity.Account"/>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-7 col-lg-7 col-xl-7">
                                                            ...
                                                            <div style="display: flex; margin-bottom: 25px;">
                                                                ...
                                                                <div id="currency" class="bfh-selectbox bfh-currencies"
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${account.isBlocked}">
                                                                        <a class="list-group-item list-group-item-action list-group-item-button-primary"
                                                                           ...
                                                                           role="tab" aria-controls="unblockAccount">
                                                                                ${unblockAccount} <span
                                                                                class="arrow-link-symbol">→</span>
                                                                        </a>
                                                                    </c:when>
