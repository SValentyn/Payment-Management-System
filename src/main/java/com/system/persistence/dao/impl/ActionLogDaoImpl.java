...
public class ActionLogDaoImpl implements ActionLogDao {
    ...
    private static final String FIND_LOG_ENTRY_BY_ID = "SELECT * FROM action_log WHERE log_entry_id = ?";
    private static final String FIND_LOG_ENTRIES_BY_USER_ID = "SELECT * FROM action_log WHERE user_id = ?";
